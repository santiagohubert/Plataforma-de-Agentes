                ...
                return (
                  ...
                  >
                    <div
                      ...
                      title={`Proyecto: ${project.name} (Hacé clic para desplegar o arrastrá un chat acá)`}
                    >
                    ...
                    {isExpanded && (
                      <div className="project-chats-list">
                        {projectChats.length === 0 ? (
                          <div className="sidebar-empty-subhint">Sin chats aún (arrastrá o creá uno)</div>
                        ) : (
                          projectChats.map((chat) => (
                            <div
                              ...
                              title="Arrastrá este chat a otro proyecto o hacé clic para abrirlo"
                            >
                              ...
                              <div className="chat-item-actions" onClick={(e) => e.stopPropagation()}>
                                <button
                                  ...
                                  title="Asignar o cambiar de proyecto"
                                >
                                  <FolderInput size={14} />
                                </button>
                                <button
            ...
            <div className="standalone-chats-list">
              {standaloneConversations.map((chat) => (
                <div
                  ...
                  draggable
                  onDragStart={(e) => handleDragStart(e, chat.id)}
                  title="Arrastrá este chat a un proyecto o hacé clic para abrirlo"
                >
          ...
          <div className="move-chat-popover" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="move-options">
              ...
              >
                ...
                {!activeChatToMove?.projectId && <Check size={14} className="text-primary" />}
              </button>
